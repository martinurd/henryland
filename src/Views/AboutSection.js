...
const AboutSection = () => {
    useEffect(() => {
        ...
        console.log('Image paths:', {
            muPic1: muPic1 ? 'loaded' : 'missing',
            muPic2: muPic2 ? 'loaded' : 'missing'
        });
    }, []);
    ...
    return (
        <section id="about-section" className="pt-16 pb-16 px-4 md:px-8 bg-[#2F4C44]">
            {console.log('AboutSection JSX rendering')}
                                ...
                                <div className="w-[300px] h-[300px] overflow-hidden rounded-lg">
                                    <img 
                                        ...
                                        onError={(e) => {
                                            console.log('Image failed to load:', e);
                                            e.target.onerror = null;
                                            e.target.src = 'data:image/svg+xml;base64,';
                                        }}
                                    />
                                </div>
                                <div className="mt-4 w-[300px]">
